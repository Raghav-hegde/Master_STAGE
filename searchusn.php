...
print "<center>STUDENT '$id' NOT FOUND</center>";
 mysql_close($conn);
 }
 ?>
...
<center>
<fieldset>
<h2> ENTER THE STUDENT ID TO BE SEARCHED</h2><br/>
<form action="searchusn.php" method="GET">
